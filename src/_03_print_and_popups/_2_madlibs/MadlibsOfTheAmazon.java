...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective=JOptionPane.showInputDialog("Can you please enter in an adjective? ");
		// Get the player to enter a type of liquid
		String liquid=JOptionPane.showInputDialog("Can you please enter a type of liquid? ");
		// Get the player to enter a body part
		String body_part=JOptionPane.showInputDialog("Can you please enter a body part? ");		
		// Get the player to enter a verb
		String verb=JOptionPane.showInputDialog("Can you please enter a verb? ");
		// Get the player to enter a place
		String place=JOptionPane.showInputDialog("Can you please enter a place? ");
